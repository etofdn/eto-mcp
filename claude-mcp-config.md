  ...
  "mcpServers": {
    "eto-mcp": {
      ...
      "env": {
        ...
        "AUDIT_SIGNING_KEY_PATH": ""  // optional: path to an Ed25519 private key (32-byte raw, hex, or PKCS#8 PEM) used to sign audit-trail / travel-rule VCs (FN-084); omit or leave empty for NoOpVcSigner (unsigned)
      }
    }
  }
}
